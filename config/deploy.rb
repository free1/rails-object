...
# use http
# set :repo_url, ''https://xx.com/freeloverails/weixin_test.git/'
...
set :linked_dirs, %w{log tmp/pids tmp/cache tmp/sockets vendor/bundle public/system solr/data solr/pids node_modules}
